...
//        imageView.layer.borderWidth = 0.8
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?){
        ...
        weightRepsView.rightAnchor.constraint(equalTo: rightAnchor, constant: -16).isActive = true
        
        addSubview(weightXreps)
        weightXreps.leftAnchor.constraint(equalTo: weightRepsView.leftAnchor, constant: 5).isActive = true
        weightXreps.topAnchor.constraint(equalTo: weightRepsView.topAnchor, constant: 5).isActive = true
        weightXreps.rightAnchor.constraint(equalTo: weightRepsView.rightAnchor, constant: -5).isActive = true
        ...
        notes.topAnchor.constraint(equalTo: weightRepsView.bottomAnchor, constant: 15).isActive = true
